        ...
        <>
            <div className="w-full flex items-center justify-between p-4 bg-[#F9FAFC] rounded-2xl md:p-[20px]">
                <div className="w-auto flex items-center justify-center gap-4">
                    <div className="w-[60px] h-[60px] bg-white border border-[#F2F2F2] rounded-full flex items-center justify-center overflow-hidden">
                        <img src={product?.icon} alt="product icon" />
                    </div>
                    <div className="w-auto space-y-2">
                        <h4 className="font-family text-base font-semibold text-[#101727] md:text-lg lg:text-xl">{product?.name}</h4>
